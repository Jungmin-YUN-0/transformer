...
parser.add_argument('-data_task', default="MT", help="MT(machine translation) / CF(classification)" )

parser.add_argument('-data_pkl', default="machinetranslation_wmt16_512.pickle", help="file name of preprocessed data(pickle file)")
parser.add_argument('-model_save', default="transformer_BASE.pt", help="name of saved(updated) model")
