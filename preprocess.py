...
def main():
    ...
    parser.add_argument('-data_dir', required=True, help="directory of dataset")
    parser.add_argument('-data_ext', required=True, help="extension of dataset")
    ...
    # make dataset #
    ################
    train_data = TabularDataset(path= './'+opt.data_dir+"/train."+opt.data_ext, format=opt.data_ext, fields=[('src', SRC), ('trg', TRG)])
    valid_data = TabularDataset(path='./'+opt.data_dir+"/val."+opt.data_ext, format=opt.data_ext, fields=[('src', SRC), ('trg', TRG)])
    test_data = TabularDataset(path='./'+opt.data_dir+"/test."+opt.data_ext, format=opt.data_ext, fields=[('src', SRC), ('trg', TRG)])
